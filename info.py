...
BOT_TOKEN = environ.get('BOT_TOKEN', "7401282886:AAH-sWbTntlQzPyc7mVAi3zj49lepTgqbg8")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7328629001').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002830799613').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002370816678'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002370816678'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002370816678'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002370816678'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002485124074')  # Channel/Group ID for force sub (make sure bot is admin)
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002485124074').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002485124074').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://telegra.ph/HgBotz-07-16-2')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'rohit23pnb@axl')
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://koyeb77user:rohit870@cluster0.wgdkp.mongodb.net/?retryWrites=true&w=majority")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://koyeb67user:rohit870@cluster0.fuqhj.mongodb.net/?retryWrites=true&w=majority")
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/FILE_SHARINGBOTS')
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/Javpostr')
OWNERID = int(os.environ.get('OWNERID', '7328629001'))  # Replace with the actual admin ID
